...
const MobileNavBar = ({ state }: States) => {
  ...
  return (
    <nav
      className="md:block hidden fixed inset-0 top-[3.8rem] left-0 w-72 h-screen z-[200] px-3 pt-4 bg-[--background-color] dark:bg-[#111111] text-[#373737]"
